...
int main() {
    ...
    folderName = "VKU Summer 2025 - Contest 4 Matrix Mul";
    // std::cin >> folderName;
    ...
    if (mkdir(folderName.c_str()) == 0) { // 0777 for full permissions (you can change permissions as needed)
        ...
        if (getcwd(cwd, sizeof(cwd)) != NULL) {
            ...
            std::ofstream inputFile(currentDir + "/" + folderName + "/WF.inp");
            std::ofstream outputFile(currentDir + "/" + folderName + "/WF.out");
